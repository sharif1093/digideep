...
cpanel["num_workers"] = 8     # From Explorer           # Number of exploratory workers working together
cpanel["n_steps"] = 128       # From Explorer           # Number of frames to produce
...
cpanel["entropy_coef"] = 0.01    # 0.01 # Entropy term coefficient
cpanel["max_grad_norm"] = 0.50   # Max norm of gradients
cpanel["use_clipped_value_loss"] = True


# add_image_transpose  = True  # ** Necessary if training on Gym with renders, e.g. Atari games
# add_frame_stack_axis = True  # ** Necessary for training on renders, e.g. Atari games. The nstack parameter is usually 4
#                                          # This stacks frames at a custom axis. If the ImageTranspose is activated
#                                          # then axis should be set to 0 for compatibility with PyTorch.
...
def gen_params(cpanel):
    ...
    # params["env"]["config"]["max_episode_steps"] # Maximum number of steps in env
