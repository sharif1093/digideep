...
cpanel["batch_size"] = 256 # From Agents
cpanel["warm_start"] = 10000

#####################
### Agents Parameters
cpanel["lr_critic"] = 0.0003
cpanel["lr_actor"]  = 0.0003

# cpanel["eps"] = 1e-5 # Epsilon parameter used in the optimizer(s) (ADAM/RMSProp/...)

cpanel["polyak_factor"] = 0.005 # tau
cpanel["alpha"] = 0.2 # Entropy Temperature
cpanel["automatic_entropy_tuning"] = False

cpanel["hidden_size"] = 256
...
def gen_params(cpanel):
    ...
    params["agents"]["agent"]["type"] = "digideep.agent.sacv2.Agent"
    ...
    params["agents"]["agent"]["methodargs"]["alpha"] = cpanel["alpha"]  # Entropy temperature, alpha
    params["agents"]["agent"]["methodargs"]["automatic_entropy_tuning"] = cpanel["automatic_entropy_tuning"]  # Automatically tune alpha (entropy temperature)
    ...
    observation_path = params["agents"]["agent"]["observation_path"]
    params["agents"]["agent"]["policyname"] = "digideep.agent.sacv2.Policy"
    params["agents"]["agent"]["policyargs"] = {"obs_space": params["env"]["config"]["observation_space"][observation_path],
                                               ...
                                               "hidden_size": cpanel["hidden_size"],
                                               "epsilon": 1e-6,
                                               "critic_args": {},
                                               "actor_args": {"log_std_min":-20, "log_std_max":2},
                                               "average_args": {"mode":"soft", "polyak_factor":cpanel["polyak_factor"], "interval":cpanel["target_update_interval"]},
